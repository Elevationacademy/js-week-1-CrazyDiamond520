...
//extension
 ...
 for(let i of keys){
     ...
     if(i=='A'){
         for(let j in dictionary.A){
             console.log(dictionary.A[j])
         }
     }
     if(i=='B'){
         for(let j in dictionary.B)
         console.log(dictionary.B[j])
     }
     if(i=='C'){
         for(let j in dictionary.C){
             console.log(dictionary.C[j])
         }
     }
